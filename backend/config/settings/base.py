...
SPECTACULAR_SETTINGS = {
    "TITLE": "Technodha LeaveMate API",
    "DESCRIPTION": "Production-ready REST API for Technodha LeaveMate — Smart Employee Leave Management System, supporting Authentication, Employee Leave Applications, and Manager Approval Workflows.",
    "VERSION": "1.0.0",
