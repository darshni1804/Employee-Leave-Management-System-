...
export function TopNavbar({ onToggleSidebar, sidebarOpen }: TopNavbarProps) {
  ...
  return (
    <>
          ...
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
              <DropdownMenu.Content
                className="z-50 min-w-[210px] rounded-xl border border-[#E5E7EB] bg-white p-1.5 shadow-lg animate-fade-in data-[side=bottom]:slide-in-from-top-2"
                sideOffset={6}
                align="end"
              >
                {/* User info header */}
                ...
                <DropdownMenu.Item
                  ...
                  className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-[#374151] hover:bg-[#F3F4F6] cursor-pointer outline-none transition-colors"
                >
      ...
      {/* Settings Modal (mounted at navbar level to avoid z-index conflicts) */}
